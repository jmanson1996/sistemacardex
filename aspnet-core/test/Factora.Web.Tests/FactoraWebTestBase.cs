...
{
    public abstract class FactoraWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FactoraWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FactoraWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FactoraDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FactoraDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FactoraDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FactoraDbContext, Task<T>> func)
        {
            T result;
